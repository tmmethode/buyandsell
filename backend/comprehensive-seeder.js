...
// Sample users from frontend data
const sampleUsers = [
  {
    firstName: 'John',
    lastName: 'Doe',
...
// Comprehensive house data from frontend
const sampleHouses = [
  // Luxury Houses
  {
    ...
    images: [
      "/uploads/houses/house1.png",
      "/uploads/houses/house2.png",
      "/uploads/houses/house3.png"
    ],
    bedrooms: 5,
    bathrooms: 4,
    area: 3200,
    ...
    propertyType: "Villa",
    condition: "Excellent",
    amenities: ["Swimming Pool", "Garden", "Security", "Parking", "Modern Kitchen", "Master Suite"],
    features: ["Balcony", "Walk-in Closet", "Home Theater", "Wine Cellar"],
    parking: true,
    parkingSpaces: 3,
    furnished: true,
    security: true,
  ...
  },
  {
    ...
    images: [
      "/uploads/houses/house2.png",
      "/uploads/houses/house4.png",
      "/uploads/houses/house5.png"
    ],
    bedrooms: 3,
    bathrooms: 2,
    area: 1800,
  ...
  },
  {
    ...
    priceNumeric: 49400000,
    location: "Kigali",
    mainImage: "/uploads/houses/house3.png",
    images: [
      "/uploads/houses/house3.png",
      "/uploads/houses/house6.png",
      "/uploads/houses/house7.png"
    ],
    bedrooms: 3,
    bathrooms: 2,
    area: 1800,
  ...
  // Middle Class Houses
  {
    ...
    images: [
      "/uploads/houses/house11.jpg",
      "/uploads/houses/house12.jpg",
      "/uploads/houses/house13.jpg"
    ],
    bedrooms: 4,
    bathrooms: 2,
    area: 310,
    ...
    propertyType: "House",
    condition: "Good",
    amenities: ["Garden", "Parking", "Living Room"],
    features: ["Modern Kitchen", "Balcony", "Storage Space"],
    parking: true,
    parkingSpaces: 1,
    furnished: false,
    security: false,
  ...
  },
  {
    ...
    location: "Nyamirambo",
    mainImage: "/uploads/houses/house21.jpg",
    images: [
      "/uploads/houses/house21.jpg",
      "/uploads/houses/house22.jpg",
      "/uploads/houses/house31.jpg"
    ],
    bedrooms: 4,
    bathrooms: 1,
    area: 680,
    ...
    propertyType: "House",
    condition: "Good",
    amenities: ["Garden", "Parking", "Large Living Room"],
    features: ["Modern Kitchen", "Balcony", "Extra Storage"],
    parking: true,
    parkingSpaces: 2,
    furnished: false,
    security: false,
  ...
  // Additional houses from frontend images
  {
    ...
    images: [
      "/uploads/houses/house41.jpg",
      "/uploads/houses/house51.jpg",
      "/uploads/houses/house52.jpg"
    ],
    bedrooms: 4,
    bathrooms: 3,
    area: 450,
  ...
  },
  {
    ...
    images: [
      "/uploads/houses/house61.jpg",
      "/uploads/houses/house62.jpg",
      "/uploads/houses/house63.jpg"
    ],
    bedrooms: 5,
    bathrooms: 4,
    area: 520,
...
// Comprehensive car data from frontend
const sampleCars = [
  {
    ...
    images: [
      "/uploads/cars/car1.png",
      "/uploads/cars/car2.png",
      "/uploads/cars/car3.png"
    ],
    brand: "Toyota",
    model: "Camry",
    year: 2020,
    ...
    seats: 5,
    condition: "Excellent",
    features: ["Bluetooth", "Backup Camera", "Cruise Control", "Leather Seats"],
    safetyFeatures: ["ABS", "Airbags", "Stability Control", "Lane Departure Warning"],
    comfortFeatures: ["Climate Control", "Power Windows", "Power Seats", "Sunroof"],
    isImported: false,
    hasWarranty: true,
    contactPhone: "+250780123456",
    contactEmail: "john@example.com",
  ...
  },
  {
    ...
    images: [
      "/uploads/cars/car2.png",
      "/uploads/cars/car4.png",
      "/uploads/cars/car5.png"
    ],
    brand: "Honda",
    model: "CR-V",
    year: 2021,
    ...
    safetyFeatures: ["ABS", "Airbags", "Lane Assist", "Blind Spot Monitoring"],
    comfortFeatures: ["Leather Seats", "Climate Control", "Power Seats", "Heated Seats"],
    isImported: false,
    hasWarranty: true,
    contactPhone: "+250781234567",
    contactEmail: "jane@example.com",
  ...
  },
  {
    ...
    images: [
      "/uploads/cars/car3.png",
      "/uploads/cars/car6.png",
      "/uploads/cars/car7.png"
    ],
    brand: "BMW",
    model: "X3",
    year: 2022,
  ...
  // Additional cars from frontend images
  {
    ...
    images: [
      "/uploads/cars/car8.png",
      "/uploads/cars/car9.png",
      "/uploads/cars/car10.png"
    ],
    brand: "Toyota",
    model: "Land Cruiser",
    year: 2019,
  ...
  },
  {
    ...
    description: "Automatic • 35,000 km • Petrol",
    category: "Car",
    price: "RWF 65,000,000",
    priceNumeric: 65000000,
    location: "Kigali",
    mainImage: "/uploads/cars/car4.png",
    images: [
      "/uploads/cars/car4.png",
      "/uploads/cars/car5.png"
    ],
    ...
    seats: 5,
    condition: "Excellent",
    features: ["Bluetooth", "Backup Camera", "Navigation", "Leather Seats"],
    safetyFeatures: ["ABS", "Airbags", "Stability Control", "Lane Keep Assist"],
    comfortFeatures: ["Climate Control", "Power Windows", "Power Seats", "Ambient Lighting"],
    isImported: true,
    hasWarranty: true,
    contactPhone: "+250784567890",
    contactEmail: "charlie@example.com",
...
// Comprehensive plot data from frontend
const samplePlots = [
  {
    ...
    images: [
      "/uploads/plots/plot11.jpg",
      "/uploads/plots/plot1.png",
      "/uploads/plots/plot2.png"
    ],
    area: 633,
    areaUnit: "sqm",
    shape: "Rectangular",
    ...
    nearbyFacilities: ["School", "Market", "Hospital", "Transport"],
    titleDeed: true,
    contactPhone: "+250780123456",
    contactEmail: "john@example.com",
    status: "Available",
  ...
  },
  {
    ...
    images: [
      "/uploads/plots/plot21.jpg",
      "/uploads/plots/plot3.png",
      "/uploads/plots/plot4.png"
    ],
    area: 324,
    areaUnit: "sqm",
    shape: "Square",
    ...
    nearbyFacilities: ["Market", "Transport", "Shopping Center"],
    titleDeed: true,
    contactPhone: "+250781234567",
    contactEmail: "jane@example.com",
    status: "Available"
  },
  {
    ...
    images: [
      "/uploads/plots/plot31.jpg",
      "/uploads/plots/plot5.png",
      "/uploads/plots/plot6.png"
    ],
    area: 324,
    areaUnit: "sqm",
    shape: "Rectangular",
  ...
  // Additional plots from frontend images
  {
    ...
    images: [
      "/uploads/plots/plot41.jpg",
      "/uploads/plots/plot7.png",
      "/uploads/plots/plot8.png"
    ],
    area: 450,
    areaUnit: "sqm",
    shape: "Rectangular",
  ...
  {
    title: "Agricultural Land in Nyarufunzo - 2,000sqm",
    description: "Ideal for farming and agriculture",
    category: "Agricultural Land",
    price: "RWF 45,000,000",
    priceNumeric: 45000000,
    location: "Nyarufunzo",
    mainImage: "/uploads/plots/plot51.jpg",
    images: [
      "/uploads/plots/plot51.jpg",
      "/uploads/plots/plot61.jpg",
      "/uploads/plots/plot62.jpg"
    ],
    area: 2000,
    areaUnit: "sqm",
    shape: "Irregular",
    ...
    nearbyFacilities: ["Water Source", "Farming Community", "Market"],
    titleDeed: true,
    contactPhone: "+250784567890",
    contactEmail: "charlie@example.com",
    status: "Available"
...
// Comprehensive job data from frontend
const sampleJobs = [
  {
    ...
    requiredSkills: ["Node.js", "MongoDB", "Express.js", "JavaScript", "REST APIs"],
    preferredSkills: ["TypeScript", "Docker", "AWS", "Microservices", "GraphQL"],
    responsibilities: [
  ...
  },
  {
    ...
    educationLevel: "Bachelor",
    requiredSkills: ["Adobe Creative Suite", "Photoshop", "Illustrator", "Design Principles", "Typography"],
    preferredSkills: ["Figma", "UI/UX Design", "Branding", "Motion Graphics", "Print Design"],
    responsibilities: [
  ...
  // Additional jobs from frontend data
  {
  ...
  },
  {
    ...
    description: "B2B sales • Full-time",
    category: "Sales",
    salary: "RWF 1,800,000/mo + Commission",
    salaryMin: 1800000,
    salaryMax: 1800000,
    salaryCurrency: "RWF",
    salaryPeriod: "monthly",
    ...
    requiredSkills: ["Sales", "Communication", "Customer Service", "Negotiation", "CRM"],
    preferredSkills: ["B2B Sales", "Product Knowledge", "Market Research", "Presentation Skills"],
    responsibilities: [
    ...
    benefits: ["Commission Structure", "Health Insurance", "Sales Training", "Career Growth"],
    company: {
      name: "Sales Force Rwanda",
      size: "201-500",
      industry: "Sales"
    },
    contactPerson: {
      name: "Sales Manager",
      email: "sales@salesforce.rw",
      phone: "+250784567890"
    },
...
const seedData = async () => {
  try {
    ...
    console.log(`⭐ Featured Items: ${createdHouses.filter(h => h.isFeatured).length + createdCars.filter(c => c.isFeatured).length + createdPlots.filter(p => p.isFeatured).length + createdJobs.filter(j => j.isFeatured).length}`);

    console.log('\n🎉 Comprehensive data seeding completed successfully!');
    console.log('🚀 Your Rwanda Marketplace is now populated with all frontend data!');
